...
//Future<Map<String, List<Cave>>> _loadDayInput() async => await rootBundle.loadString('assets/day12.txt').then(Day13Logic.parseInput);

class Day13Logic {
  static Tuple2<List<Tuple2<int, int>>, List<Tuple2<String, int>>> parseInput(String input) {
  ...
  static part1(Tuple2<List<Tuple2<int, int>>, List<Tuple2<String, int>>> dotsAndFolds) {
  ...
  static void foldPaper(Tuple2<String, int> fold, List<Tuple2<int, int>> dots) {
    ...
    if (fold.item1 == "fold along x") {
      ...
      newDots.forEach((newDot) => dots.removeWhere((dot) => dot.item1 == newDot.item1 && dot.item2 == newDot.item2));
      dots.addAll(newDots);
    } else {
  ...
  static part2(Tuple2<List<Tuple2<int, int>>, List<Tuple2<String, int>>> dotsAndFolds) {
    var dots = dotsAndFolds.item1;
    var folds = dotsAndFolds.item2;
  ...
  static printableDots(List<Tuple2<int, int>> dots) {
